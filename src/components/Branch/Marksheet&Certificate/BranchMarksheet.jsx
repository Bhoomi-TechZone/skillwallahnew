      ...
      {showPreviewModal && selectedMarksheet && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {/* Marksheet Preview: show message when no generated file is available */}
            {!previewFileUrl && !previewLoading && (
              <div className="px-6 py-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500 max-w-sm mx-auto">
                  The marksheet document is not available for preview. Please try downloading it instead.
                </p>
              </div>
            )}
